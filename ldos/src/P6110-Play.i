...
fastVolumeSet:
	move P61_temp0+P61_Shadow(pc),(a4)
	move P61_temp1+P61_Shadow(pc),$10(a4)
	move P61_temp2+P61_Shadow(pc),$20(a4)
	move P61_temp3+P61_Shadow(pc),$30(a4)
	rts	
fastVolumeClr:
	move d0,(a4)
	move d0,$10(a4)
...
P61_nextpattern:
	...
	move.b	LDOSSeqForceJump(pc),d0
	bmi.s	.normal
	move.l P61_possibase(pc),a1
	add.w	d0,a1					; point on right seq pos ( d0 bits 15..8 are 0 because of previous moveq #63)
	move.w	d0,P61_Pos-P61_cn(a3)
	move.b	#-1,LDOSSeqForceJump-P61_cn(a3)
.normal:
...
;	ifne p61cia
	move.l P61_vektori(pc),a0
	move.l P61_oldlev6(pc),(a0)	; [arnaud] after second "setrep" interrupt, set the original one (LDOS one)
;	endc
	movem.l (sp)+,a0/a1
;	move.w #$0,$dff180
	nop
